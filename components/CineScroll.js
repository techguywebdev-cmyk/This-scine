...
function ChatWidget({ peer, onClose, accent }) {
  ...
  // call timer
  useEffect(() => {
    if (!callMode) { setCallSecs(0); return; }
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {handle ? (
              <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', marginTop: 1 }}>{handle}</div>
            ) : null}
          </div>
          ...
          >
            <SvgIcon name="phone" size={16} color="rgba(255,255,255,0.75)" />
          </button>
          <button
            type="button"
          ...
          >
            <SvgIcon name="video" size={16} color="rgba(255,255,255,0.75)" />
          </button>
          <button
            type="button"
            ...
            style={{
              ...
              height: 38,
              borderRadius: '50%',
              background: showMore ? 'rgba(255,255,255,0.1)' : 'rgba(255,255,255,0.06)',
              border: '1px solid rgba(255,255,255,0.08)',
              cursor: 'pointer',
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <SvgIcon name="more" size={16} color="rgba(255,255,255,0.75)" />
          </button>
        </div>
        ...
        {showMore && (
          ...
          >
            <button
              type="button"
              onClick={() => { setShowMore(false); setShowStickers(true); setMediaTab('stickers'); }}
              style={{
                flex: 1,
                background: 'rgba(255,255,255,0.05)',
                border: '1px solid rgba(255,255,255,0.08)',
            ...
            <button
              type="button"
              onClick={() => { setShowMore(false); setShowStickers(true); setMediaTab('gifs'); }}
              style={{
                flex: 1,
                background: 'rgba(255,255,255,0.05)',
                border: '1px solid rgba(255,255,255,0.08)',
          ...
          >
            ...
            >
              {peerInfo?.avatar_url ? (
                ...
                <span style={{ fontFamily: T.serif, fontSize: 36, fontWeight: 700, color: accent }}>
                  {(name || 'U')[0].toUpperCase()}
                </span>
              )}
            </div>
            <div style={{ fontFamily: T.serif, fontSize: 22, fontWeight: 700, fontStyle: 'italic', color: '#fff' }}>{name}</div>
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)' }}>
              {callMode === 'video' ? 'Video calling…' : 'Calling…'} · {formatCallTime(callSecs)}
            </div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.3)', maxWidth: 260, textAlign: 'center', lineHeight: 1.5 }}>
              Calls connect when both of you are free. Ringing your friend now.
            </div>
            <button
              type="button"
            ...
            >
              <SvgIcon name="phone" size={22} color="#fff" />
            </button>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>End</div>
          </div>
        )}
