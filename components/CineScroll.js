  ...
  return (
    <>
      ...
      >
        ...
        {/* Title row */}
        <div style={{ padding: '16px 20px 4px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexShrink: 0 }}>
          <div>
            <div style={{ fontFamily: T.serif, fontSize: 28, fontWeight: 800, color: '#fff', letterSpacing: -0.3 }}>
              Messages
            </div>
            <div style={{ fontSize: 12.5, color: 'rgba(255,255,255,0.4)', marginTop: 4, lineHeight: 1.4 }}>
              Stay connected. No distance, just conversations.
            </div>
          </div>
          <div style={{ display: 'flex', gap: 8, paddingTop: 4 }}>
            <button
              type="button"
              onClick={() => {
                const el = document.getElementById('cine-msg-search');
                if (el) el.focus();
              }}
              style={{
                width: 38,
            ...
            >
              <SvgIcon name="search" size={16} color="rgba(255,255,255,0.7)" />
            </button>
            <button
              type="button"
              onClick={onClose}
            ...
            >
              <SvgIcon name="close" size={15} color="rgba(255,255,255,0.55)" />
            </button>
          </div>
        </div>
          ...
          >
            ...
            {searchQ ? (
              <button
                type="button"
                onClick={() => setSearchQ('')}
                style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, color: 'rgba(255,255,255,0.35)', fontSize: 16, lineHeight: 1 }}
              >
                ×
              </button>
            ) : null}
        ...
        {/* Filter tabs — active = white bg, black text */}
        <div
          style={{
                ...
                {f.count > 0 && (
                  <span
                    style={{
                      fontSize: 11,
                      fontWeight: 700,
                      color: active ? 'rgba(0,0,0,0.45)' : 'rgba(255,255,255,0.35)',
                    }}
                  >
                    {f.count}
                  </span>
        ...
        <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', paddingBottom: 20 }}>
          {loading ? (
            ...
            filtered.map((c, i) => {
              ...
              const isSpam = spamIds.includes(c.peer_id);
              const preview = c.last_text || 'Tap to open';
              return (
                <div
                  key={c.peer_id || i}
                  style={{
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <span style={{ fontSize: 12.5, color: 'rgba(255,255,255,0.38)' }}>
                        {isSpam ? 'Spam' : c.is_request ? 'Request' : 'Tap to open'}
                      </span>
