...
function ListPlaylistPlayer({ listId, movies, startIndex = 0, onClose, accent, onSave, watchlistIds }) {
  ...
  // Load trailer via server proxy (no client TMDB key needed)
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, background: T.bg, display: 'flex', flexDirection: 'column', overflowY: 'auto', WebkitOverflowScrolling: 'touch' }}>
        ...
        {/* DISCUSSION under playlist */}
        <div style={{ padding: '8px 18px 32px', borderTop: `1px solid ${T.hairline}` }}>
          <Eyebrow color={T.text3} style={{ marginBottom: 12, paddingTop: 8 }}>
            Discussion
          </Eyebrow>
          ...
          {isSignedIn ? (
            ...
            <div style={{ fontSize: 12.5, color: T.text3, marginBottom: 14, textAlign: 'center' }}>
          ...
          {loadingComments ? (
            ...
            <div style={{ fontSize: 12.5, color: T.text3, textAlign: 'center', padding: '12px 0' }}>
