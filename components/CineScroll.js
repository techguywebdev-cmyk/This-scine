...
function ProfileSheet({onClose,accent,watchlist,setWatchlist,userReviews,loadingData,onDiscover,onWatchTrailer}){
  ...
  useEffect(()=>{
    if(tab!=='watchlist'||!watchlistPlatform||watchlist.length===0)return;
