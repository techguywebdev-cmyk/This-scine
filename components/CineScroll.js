            ...
            <div style={{ display: 'flex', gap: 6, marginBottom: 10, overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
              {Object.keys(STICKER_PACKS).map((pack) => (
                <button
                  ...
                  style={{
                    background: stickerPack === pack ? `${accent}22` : T.surface2,
                    border: `1px solid ${stickerPack === pack ? accent + '55' : T.hairline}`,
                    borderRadius: 14,
                    padding: '6px 12px',
                    fontSize: 11,
                    fontWeight: 700,
                    color: stickerPack === pack ? accent : T.text2,
                    cursor: 'pointer',
                    fontFamily: 'inherit',
                    whiteSpace: 'nowrap',
                    flexShrink: 0,
        ...
        {recording ? (
          ...
          >
            <button
              ...
              style={{
                background: showStickers ? `${accent}22` : T.surface2,
                border: `1px solid ${showStickers ? accent + '55' : T.hairline}`,
                borderRadius: 14,
                width: 42,
                height: 42,
                cursor: 'pointer',
