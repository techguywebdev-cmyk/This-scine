...
// ─── MESSAGES INBOX ─────────────────────────────────────────────────────────
// ─── Chat themes (cinema-inspired) ───────────────────────────────────────────
const CHAT_UNREAD_DOTS = ['#FF6B8A', '#4DA8FF', '#F5C842', '#1CE783', '#B07FEF', '#FF7A2F', '#00A8E0', '#FF6BAE'];

const CHAT_THEMES = {
  classic: {
    id: 'classic', label: 'Classic',
    bg: '#0a0a0f', surface: 'rgba(255,255,255,0.06)', bubbleMe: 'rgba(255,255,255,0.14)', bubbleThem: 'rgba(255,255,255,0.06)',
    accent: '#F5C842', text: 'rgba(255,255,255,0.92)', textMuted: 'rgba(255,255,255,0.45)',
  },
  batman: {
    id: 'batman', label: 'Batman',
    bg: '#050505', surface: 'rgba(245,200,66,0.08)', bubbleMe: 'rgba(245,200,66,0.22)', bubbleThem: 'rgba(255,255,255,0.06)',
    accent: '#F5C842', text: 'rgba(255,255,255,0.95)', textMuted: 'rgba(245,200,66,0.55)',
  },
  avatar: {
    id: 'avatar', label: 'Avatar',
    bg: '#021018', surface: 'rgba(0,168,224,0.1)', bubbleMe: 'rgba(0,168,224,0.28)', bubbleThem: 'rgba(255,255,255,0.06)',
    accent: '#00A8E0', text: 'rgba(230,248,255,0.95)', textMuted: 'rgba(0,168,224,0.6)',
  },
  action: {
    id: 'action', label: 'Action',
    bg: '#100808', surface: 'rgba(255,122,47,0.1)', bubbleMe: 'rgba(255,122,47,0.28)', bubbleThem: 'rgba(255,255,255,0.06)',
    accent: '#FF7A2F', text: 'rgba(255,245,235,0.95)', textMuted: 'rgba(255,122,47,0.6)',
  },
  love: {
    id: 'love', label: 'Love',
    bg: '#120810', surface: 'rgba(255,107,174,0.1)', bubbleMe: 'rgba(255,107,174,0.28)', bubbleThem: 'rgba(255,255,255,0.06)',
    accent: '#FF6BAE', text: 'rgba(255,240,248,0.95)', textMuted: 'rgba(255,107,174,0.6)',
  },
  horror: {
    id: 'horror', label: 'Horror',
    bg: '#0a0404', surface: 'rgba(229,9,20,0.1)', bubbleMe: 'rgba(229,9,20,0.28)', bubbleThem: 'rgba(255,255,255,0.05)',
    accent: '#E50914', text: 'rgba(255,230,230,0.95)', textMuted: 'rgba(229,9,20,0.55)',
  },
  scifi: {
    id: 'scifi', label: 'Sci-Fi',
    bg: '#080612', surface: 'rgba(176,127,239,0.12)', bubbleMe: 'rgba(176,127,239,0.3)', bubbleThem: 'rgba(255,255,255,0.06)',
    accent: '#B07FEF', text: 'rgba(245,240,255,0.95)', textMuted: 'rgba(176,127,239,0.6)',
  },
  nature: {
    id: 'nature', label: 'Nature',
    bg: '#06100a', surface: 'rgba(28,231,131,0.1)', bubbleMe: 'rgba(28,231,131,0.25)', bubbleThem: 'rgba(255,255,255,0.06)',
    accent: '#1CE783', text: 'rgba(235,255,245,0.95)', textMuted: 'rgba(28,231,131,0.55)',
  },
};
    ...
    <>
      ...
      >
        ...
        <div style={{ padding: '12px 16px 8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
          <div style={{ fontFamily: T.serif, fontSize: 24, fontWeight: 800, fontStyle: 'italic', color: T.text }}>Messages</div>
          <button
            type="button"
            onClick={onClose}
            style={{
        ...
        <div style={{ padding: '0 16px 10px', flexShrink: 0 }}>
          <div style={{
            ...
            <SvgIcon name="search" size={15} color="rgba(255,255,255,0.35)" />
            <input
              value={searchQ}
              onChange={(e) => setSearchQ(e.target.value)}
              placeholder="Search"
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 2 }}>
                    ...
                    <span style={{ fontSize: 12, color: isUnread ? dot : 'rgba(255,255,255,0.35)', flexShrink: 0, fontWeight: isUnread ? 600 : 400 }}>
                      {timeAgo(c.last_at)}
                    </span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <div
                      style={{
                        flex: 1,
                        fontSize: 13.5,
                        color: isUnread ? 'rgba(255,255,255,0.88)' : 'rgba(255,255,255,0.4)',
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8 }}>
              {Object.values(CHAT_THEMES).map((th) => (
                ...
                >
                  <div style={{ width: 18, height: 18, borderRadius: '50%', background: th.accent, boxShadow: `0 0 10px ${th.accent}66` }} />
