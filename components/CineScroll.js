...
function ListPlaylistPlayer({ listId, movies, startIndex = 0, onClose, accent, onSave, watchlistIds }) {
  ...
  // Clean embed: nocookie domain, minimal chrome (YouTube still requires some branding)
  const embedSrc = trailerKey
    ? `https://www.youtube-nocookie.com/embed/${trailerKey}?autoplay=1&rel=0&modestbranding=1&playsinline=1&controls=1&iv_load_policy=3&fs=1&disablekb=0&color=white`
    : null;
