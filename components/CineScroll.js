                  ...
                  <div style={{flex:1}}>
                    ...
                    {cineScore<300&&(
                      <div style={{display:'flex',gap:6,flexWrap:'wrap',marginBottom:10}}>
                        <button onClick={()=>setTab('watchlist')} style={{background:`${accent}14`,border:`1px solid ${accent}40`,borderRadius:14,padding:'5px 10px',cursor:'pointer',fontSize:10,fontWeight:700,color:accent,fontFamily:'inherit'}}>Mark watched</button>
...
export default function CineScroll(){
  ...
  const[showTonightNudge,setShowTonightNudge]=useState(false);
