...
/**
 * Web push is optional. Do NOT import('web-push') here — that breaks Vercel
 * builds when the package is not installed.
 *
 * To enable later:
 *   1. npm i web-push
 *   2. Set VAPID_PUBLIC_KEY / VAPID_PRIVATE_KEY
 *   3. Replace this stub with a real send using web-push
 */
async function sendWebPush(subscription, _payload) {
  ...
  // Package not bundled — email + in-app still work
  return { ok: false, reason: 'web_push_not_installed' };
}
